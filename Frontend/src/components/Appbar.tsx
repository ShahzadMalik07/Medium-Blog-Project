    ...
    return (
        <div className="border-b border-slate-200 flex justify-between px-8 py-3">
            <div className="flex items-center gap-3 font-medium">
                ...
                <div className="flex items-center bg-[#F9F9F9] rounded-full gap-2 px-2 py-2"><span><CiSearch className="text-2xl" /></span><input onChange={handleChange} className="outline-none bg-transparent text-sm" type="text" placeholder="Search" /></div>
